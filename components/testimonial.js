                    ...
                    <Col md="12"  className="text-center">
                        <div className="title">
                            ...
                            <div className="main-title">
                                <h2>
                                    <span className="theme-color">Отзывы от</span> наших клиентов
                            </h2>
                            </div>
                            <hr />
                            <div className="sub-title">
                                <p className="p-padding">Настоящие профессионалы. Созданный сайт супер!</p>
                            </div>
                        </div>
                    </Col>
                    <Col md="6" sm="12">
                            ...
                            <Slider {...settings}>
                                <div className="item">
                                    <div className="testimonial">
                                        <div className="testimonial-box">
                                            ...
                                            <h6>Спасибо за разработку такого сайта</h6>
                                        </div>
                                    </div>
                                ...
                                <div className="item">
                                    <div className="testimonial">
                                        <div className="testimonial-box">
                                            <img alt="dot" src="/assets/images/saas1/testimonail-dot.png" />
                                            <h6>Рекомендую, как надежного разработчика сайта!</h6>
                                        </div>
                                    </div>
                                    <div className="testi-profile">
                                        <div className="media">
                                ...
                                <div className="item">
                                    <div className="testimonial">
                                        <div className="testimonial-box">
                                            <img alt="dot" src="/assets/images/saas1/testimonail-dot.png" />
                                            <h6>Качественная разработка сайта и хорошая цена!</h6>
                                        </div>
                                    </div>
                                    <div className="testi-profile">
                                        <div className="media">
